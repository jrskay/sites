...
var OrderForm = function()
{
  ...
  this.validateOrder = $('#validate-order');
	...
	// on instancie basketSession pour avoir tout les élément de basketSession dans OrderForm donc la fonction add de basketSession onSubmitForm
...
OrderForm.prototype.onSubmitForm = function(event) {
    ...
    var mealId = this.meal.val(); // équivalent $('#meal').val();
